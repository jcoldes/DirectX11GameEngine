	...
	: m_layout(0), m_buffer(0), m_system(system)
{
	...
	{
		// SEMANTIC NAME - SEMANTIC INDEX - FLOAT - INPUT SLOT - ALIGNED BYTE OFFSET - INPUT SLOT CLASS - INSTANCE DATA STEP RATE
	...
	(layout, size_layout, shader_byte_code, size_byte_shader, &m_layout)))
	{
